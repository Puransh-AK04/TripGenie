...
customImage.style.transition = 'left 0.3s ease, top 0.3s ease';
...
customImage.style.transition = 'left 1.7s ease, top 1.7s ease, transform 0.3s ease';
...
function changeCustomImageSource(direction) {
  var imageSource = './images/944762-removebg-preview.png';
  ...
  // Set rotation angle based on direction, default to 0deg if direction not found
  var rotationAngle = rotationAngles[direction] || '0deg';

  // Apply rotation to the image
  customImage.src = imageSource;
  customImage.style.transform = 'rotate(' + rotationAngle + ')';
...
centerImage.addEventListener('click', function () {
  ...
  startButton.click(); // Simulate a click event on the start button
});